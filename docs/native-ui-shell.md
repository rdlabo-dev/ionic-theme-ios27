...
Omitting `components` enables every supported component for backward compatibility. An empty array projects none. Component names are type-checked by `NativeUIShellComponent`.
